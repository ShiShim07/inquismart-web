...
<head>
    ...
    <title>InquiSmart — Reset Password</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before { content:''; position:absolute; top:-200px;left:-200px; width:500px;height:500px; background:radial-gradient(circle,rgba(0,229,196,0.12) 0%,transparent 65%); pointer-events:none; }
        ...
        .sub { font-size:12.5px;color:#9BA5C0;margin-bottom:26px;line-height:1.5; }
        ...
        input[type="email"] { width:100%;padding:10px 12px 10px 36px;border:1.5px solid #E4E8F2;border-radius:10px;font-size:13.5px;color:#0D1B3E;background:#F8FAFF;outline:none;font-family:'DM Sans',sans-serif;transition:all 0.2s; }
        ...
        .btn-back { display:flex;align-items:center;justify-content:center;gap:5px;width:100%;padding:10px;background:transparent;color:#1A3FC4;border:1.5px solid #C7D2FE;border-radius:12px;font-size:13.5px;font-weight:600;cursor:pointer;font-family:'DM Sans',sans-serif;transition:all 0.18s;margin-top:10px;text-decoration:none; }
        .btn-back:hover { background:#EEF2FF;border-color:#1A3FC4;color:#1A3FC4;text-decoration:none; }
        .success-box { background:#EDFFF9;border:1px solid #C0F5E4;border-radius:10px;padding:10px 14px;font-size:12.5px;color:#076B4A;margin-bottom:18px;display:flex;align-items:center;gap:8px; }

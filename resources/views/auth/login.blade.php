...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .divider hr { flex: 1; border: none; border-top: 1px solid #F1F5F9; }
...
<div class="card">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="field">
            ...
            <input type="email" name="email" placeholder="admin@nancellphone.com" value="{{ old('email') }}" required autofocus>
        </div>

        <label>Password</label>
        <div class="field">
            <i class="bi bi-lock"></i>
            <input type="password" name="password" id="pw" placeholder="Enter password" required style="padding-right:38px;">
